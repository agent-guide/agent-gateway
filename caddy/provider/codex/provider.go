...
import (
	...
	runtimecodex "github.com/agent-guide/agent-gateway/pkg/llm/provider/codex"
...
func (Provider) CaddyModule() caddy.ModuleInfo {
	return caddy.ModuleInfo{
		ID:  "llm.providers.codex",
		New: func() caddy.Module { return new(Provider) },
	}
}

func (p *Provider) Provision(_ caddy.Context) error {
	if err := caddyprovider.ValidateProviderType(&p.ProviderConfig, "codex"); err != nil {
		return err
	}
	built, err := runtimecodex.New(p.ProviderConfig)
	if err != nil {
		return err
	}
	p.Runtime = built
